...
export default function CBTSection() {
  ...
  return (
    <section id="cbt" ref={ref} className="relative py-12 md:py-32 overflow-hidden" style={{ background: "linear-gradient(180deg, hsl(var(--background)) 0%, hsl(0 60% 12%) 50%, hsl(var(--background)) 100%)" }}>
